...
from locators import HeaderLocators, LoginPageLocators, RegisterPageLocators, HomePageLocators, PasswordRecoveryPageLocators
from urls import URL
from data import LoginValues

class TestLogin:
    def test_login_by_main_page_enter_account_button_login_successfully(self, driver):
    ...
    def test_login_by_personal_account_button_login_successfully(self, driver):
        driver.get(URL.HOME_PAGE_URL)
    ...
    def test_login_by_registration_page_enter_account_button_login_successfully(self, driver):
        driver.get(URL.HOME_PAGE_URL)
        driver.find_element(*HeaderLocators.PERSONAL_ACCOUNT_BUTTON).click()
        WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(LoginPageLocators.ENTER_BUTTON))
    ...
    def test_login_by_password_recovery_form_enter_account_button_login_successfully(self, driver):
        driver.get(URL.HOME_PAGE_URL)
        driver.find_element(*HeaderLocators.PERSONAL_ACCOUNT_BUTTON).click()
        WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(LoginPageLocators.ENTER_BUTTON))
