...
class TestPersonalAccount:
    def test_personal_account_button_click_not_authorised_user_open_login_page(self, driver):
    ...
    def test_personal_account_button_click_authorised_user_open_profile_page(self, driver):
        driver.get(URL.HOME_PAGE_URL)
    ...
    def test_click_to_constructor_button_in_personal_account_page_authorised_user_open_main_page(self, driver):
        driver.get(URL.HOME_PAGE_URL)
        driver.find_element(*HomePageLocators.ENTER_ACCOUNT_BUTTON).click()
        WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(LoginPageLocators.ENTER_BUTTON))
        driver.find_element(*LoginPageLocators.EMAIL_INPUT).send_keys(LoginValues.EMAIL)
    ...
    def test_click_to_logo_in_personal_account_page_authorised_user_open_main_page(self, driver):
        driver.get(URL.HOME_PAGE_URL)
        driver.find_element(*HomePageLocators.ENTER_ACCOUNT_BUTTON).click()
        WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(LoginPageLocators.ENTER_BUTTON))
        driver.find_element(*LoginPageLocators.EMAIL_INPUT).send_keys(LoginValues.EMAIL)
